...
class MF(object):
    ...
    def uhat(self):
        ...
        with open('Appliances_5_t.json', 'rb') as f_in, gzip.open('test.json.gz', 'wb') as f_out:
    ...
    def vhat(self):
        ...
        with open('Appliances_5_test.json', 'rb') as f_in, gzip.open('test.json.gz', 'wb') as f_out:
          shutil.copyfileobj(f_in, f_out)
        df = getDF('test.json.gz') #讀檔
